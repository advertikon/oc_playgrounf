...
<html>
	...
	* {
	...
	.top {
		...
		background-image: <?php echo $this->get_bg_img( $top['bg']['img']['img'], ! empty( $top['bg']['img']['embed'] ) ); ?>;
		background-repeat: <?php echo $top['bg']['img']['repeat']; ?>;
	}
	...
	.bottom {
		...
		background-image: <?php echo $this->get_bg_img( $bottom['bg']['img']['img'], ! empty( $bottom['bg']['img']['embed'] ) ); ?>;
		background-repeat: <?php echo $bottom['bg']['img']['repeat']; ?>;
	}
	...
	<body class="body" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0">
			...
			<tr>
				...
				<![endif]-->
					...
					<table class="wrapper" cellpadding="0" cellspacing="0" border="0" align="center" >
						...
						<tr>
							<td align="center">
								...
								<table class="container" cellpadding="0" cellspacing="0" border="0">
									<tr>
										<td class="spacer spacer-top-top">&nbsp;</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td class="spacer spacer-header-top">&nbsp;</td>
									</tr>
									<tr>
										<td><center>
									...
									<tr>
										<td class="spacer spacer-footer-bottom">&nbsp;</td>
									</tr>
									<tr>
										<td>
						...
						<tr>
							<td class="spacer spacer-bottom-bottom">&nbsp;</td>
						</tr>                        
					</table> 
					<!-- End Wrapper  -->  
