...
<html>
	...
	<title><?php echo $helper->get_template_subject( $template_content, $store_id, $lang_id ); ?></title>
	...
	* {
	...
	.sidebar {
		font-size: <?php echo $sidebar['flex']['text']['size']['value'] . $sidebar['flex']['text']['size']['units']; ?>;
		color: <?php echo $sidebar['flex']['text']['color']; ?>;
		width:  <?php echo ( 100 - $columns['width'] ); ?>%;
		background-color: <?php echo $sidebar['flex']['bg']['color']; ?>;
		background-image: <?php echo $this->get_bg_img( $sidebar['flex']['bg']['img']['img'], $show_img ); ?>;
		background-repeat: <?php echo $sidebar['flex']['bg']['img']['repeat']; ?>;
		text-align: <?php echo $sidebar['flex']['text']['align']; ?>;
		vertical-align: <?php echo $sidebar['flex']['text']['valign']; ?>;
	}
	...
	<body class="body" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" style="overflow-y:hidden;">

		<!-- Start Background -->
		<table class="body" cellpadding="0" cellspacing="0" style="border-collapse: collapse;" align="center" >
			<tr>
						...
						<tr>
							<td align="center">
								...
								<table class="container" cellpadding="0" cellspacing="0" border="0">
									<tr>
										<td colspan="3" class="spacer spacer-top-top">&nbsp;</td>
									</tr>
									<tr>
										<td colspan="3">
											<table class="top" width="100%" border="0" cellpadding="5" cellspacing="0">
												<tr>
													<td class="top-text">
									...
									<tr>
										<td ccolspan="3" lass="spacer spacer-header-top">&nbsp;</td>
									</tr>
									<tr>
										<td colspan="3">
											<table class="header" width="100%" border="0" cellpadding="5" cellspacing="0">
									...
									<tr>
										<td colspan="3" class="spacer spacer-content-top">&nbsp;</td>
									</tr>
									<tr>
										<td>
											<table
												...
												cellpadding="5"
												cellspacing="0"
												align="<?php echo ( empty($sidebar['flex']['right']) ? 'right' : 'left' ); ?>"
											>
												<tr>
													<td>
											...
											<table
												...
												cellpadding="5"
												cellspacing="0" 
												align="<?php echo ( empty($sidebar['flex']['right']) ? 'left' : 'right' ); ?>"
											>
												<tr>
													<td>
